...
"""autogenerated by genpy from exploration3d_msgs/SurfaceFrontierRepresentatives.msg. Do not edit."""
import sys
...
class SurfaceFrontierRepresentatives(genpy.Message):
  _md5sum = "d678cc4232ba33d9b77e1f95c1049c54"
  _type = "exploration3d_msgs/SurfaceFrontierRepresentatives"
...
float64 z
"""
  __slots__ = ['header','surface_frontiers']
  _slot_types = ['std_msgs/Header','exploration3d_msgs/SurfaceFrontierRepresentative[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SurfaceFrontierRepresentatives, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.surface_frontiers is None:
        self.surface_frontiers = []
    else:
      self.header = std_msgs.msg.Header()
      self.surface_frontiers = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.surface_frontiers)
      buff.write(_struct_I.pack(length))
      for val1 in self.surface_frontiers:
        _v1 = val1.p
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.surface_frontiers.append(val1)
      return self
