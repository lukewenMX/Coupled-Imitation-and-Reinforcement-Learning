...
"""autogenerated by genpy from planning_msgs/PolygonWithHolesStamped.msg. Do not edit."""
import sys
...
class PolygonWithHolesStamped(genpy.Message):
  ...
  _type = "planning_msgs/PolygonWithHolesStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','planning_msgs/PolygonWithHoles']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.polygon is None:
        self.polygon = planning_msgs.msg.PolygonWithHoles()
    else:
      self.header = std_msgs.msg.Header()
      self.altitude = 0.
      self.polygon = planning_msgs.msg.PolygonWithHoles()
