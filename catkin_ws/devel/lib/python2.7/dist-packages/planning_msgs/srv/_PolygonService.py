...
"""autogenerated by genpy from planning_msgs/PolygonServiceRequest.msg. Do not edit."""
import sys
...
class PolygonServiceRequest(genpy.Message):
  ...
  _type = "planning_msgs/PolygonServiceRequest"
...
"""
  __slots__ = ['polygon']
  _slot_types = ['planning_msgs/PolygonWithHolesStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.polygon is None:
        self.polygon = planning_msgs.msg.PolygonWithHolesStamped()
    else:
      self.polygon = planning_msgs.msg.PolygonWithHolesStamped()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = planning_msgs.msg.Point2D()
        _x = val1
        start = end
        end += 16
      ...
      for i in range(0, length):
        val1 = planning_msgs.msg.Polygon2D()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.points = []
        for i in range(0, length):
          val2 = planning_msgs.msg.Point2D()
          _x = val2
          start = end
          end += 16
          (_x.x, _x.y,) = _get_struct_2d().unpack(str[start:end])
...
def _get_struct_d():
    ...
    return _struct_d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from planning_msgs/PolygonServiceResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PolygonServiceResponse(genpy.Message):
  ...
  _type = "planning_msgs/PolygonServiceResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
bool success
...
class PolygonService(object):
  _type          = 'planning_msgs/PolygonService'
