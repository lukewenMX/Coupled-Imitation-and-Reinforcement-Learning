...
(cl:defclass <PlannerService-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (polynomial_plan
    ...
    :type planning_msgs-msg:PolynomialTrajectory4D
    :initform (cl:make-instance 'planning_msgs-msg:PolynomialTrajectory4D))
   (sampled_plan
    :reader sampled_plan
...
(cl:defmethod polynomial_plan-val ((m <PlannerService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-srv:polynomial_plan-val is deprecated.  Use planning_msgs-srv:polynomial_plan instead.")
  (polynomial_plan m))

(cl:ensure-generic-function 'sampled_plan-val :lambda-list '(m))
(cl:defmethod sampled_plan-val ((m <PlannerService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-srv:sampled_plan-val is deprecated.  Use planning_msgs-srv:sampled_plan instead.")
  (sampled_plan m))
