...
(cl:defclass <PolygonService-request> (roslisp-msg-protocol:ros-message)
  ((polygon
    :reader polygon
    :initarg :polygon
    :type planning_msgs-msg:PolygonWithHolesStamped
    :initform (cl:make-instance 'planning_msgs-msg:PolygonWithHolesStamped)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PolygonService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-srv:<PolygonService-request> is deprecated: use planning_msgs-srv:PolygonService-request instead.")))

(cl:ensure-generic-function 'polygon-val :lambda-list '(m))
(cl:defmethod polygon-val ((m <PolygonService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-srv:polygon-val is deprecated.  Use planning_msgs-srv:polygon instead.")
  (polygon m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PolygonService-request>)))
  ...
  "planning_msgs/PolygonServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PolygonService-request)))
  "Returns string type for a service object of type 'PolygonService-request"
  "planning_msgs/PolygonServiceRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PolygonService-request>)))
  ...
  (cl:format cl:nil "~%~%planning_msgs/PolygonWithHolesStamped polygon~%~%================================================================================~%MSG: planning_msgs/PolygonWithHolesStamped~%# A message to define a 2D polygon with holes, stamp, and altitude above ground.~%Header header~%float64 altitude~%planning_msgs/PolygonWithHoles polygon~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: planning_msgs/PolygonWithHoles~%# A message to define a 2D polygon with holes.~%planning_msgs/Polygon2D hull~%planning_msgs/Polygon2D[] holes~%~%================================================================================~%MSG: planning_msgs/Polygon2D~%# A specification of a 2D polygon where the first and last points are assumed to be connected.~%planning_msgs/Point2D[] points~%~%================================================================================~%MSG: planning_msgs/Point2D~%# This contains the position of a 2D point.~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PolygonService-request)))
  "Returns full string definition for message of type 'PolygonService-request"
  (cl:format cl:nil "~%~%planning_msgs/PolygonWithHolesStamped polygon~%~%================================================================================~%MSG: planning_msgs/PolygonWithHolesStamped~%# A message to define a 2D polygon with holes, stamp, and altitude above ground.~%Header header~%float64 altitude~%planning_msgs/PolygonWithHoles polygon~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: planning_msgs/PolygonWithHoles~%# A message to define a 2D polygon with holes.~%planning_msgs/Polygon2D hull~%planning_msgs/Polygon2D[] holes~%~%================================================================================~%MSG: planning_msgs/Polygon2D~%# A specification of a 2D polygon where the first and last points are assumed to be connected.~%planning_msgs/Point2D[] points~%~%================================================================================~%MSG: planning_msgs/Point2D~%# This contains the position of a 2D point.~%float64 x~%float64 y~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <PolygonService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-srv:<PolygonService-response> is deprecated: use planning_msgs-srv:PolygonService-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <PolygonService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-srv:success-val is deprecated.  Use planning_msgs-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PolygonService-response>)))
  ...
  "planning_msgs/PolygonServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PolygonService-response)))
  "Returns string type for a service object of type 'PolygonService-response"
  "planning_msgs/PolygonServiceResponse")
