...
(cl:defclass <Polygon2D> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector planning_msgs-msg:Point2D)
   :initform (cl:make-array 0 :element-type 'planning_msgs-msg:Point2D :initial-element (cl:make-instance 'planning_msgs-msg:Point2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Polygon2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Polygon2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-msg:<Polygon2D> is deprecated: use planning_msgs-msg:Polygon2D instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Polygon2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:points-val is deprecated.  Use planning_msgs-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Polygon2D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'planning_msgs-msg:Point2D))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Polygon2D>)))
  ...
  (cl:format cl:nil "# A specification of a 2D polygon where the first and last points are assumed to be connected.~%planning_msgs/Point2D[] points~%~%================================================================================~%MSG: planning_msgs/Point2D~%# This contains the position of a 2D point.~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Polygon2D)))
  "Returns full string definition for message of type 'Polygon2D"
  (cl:format cl:nil "# A specification of a 2D polygon where the first and last points are assumed to be connected.~%planning_msgs/Point2D[] points~%~%================================================================================~%MSG: planning_msgs/Point2D~%# This contains the position of a 2D point.~%float64 x~%float64 y~%~%~%"))
