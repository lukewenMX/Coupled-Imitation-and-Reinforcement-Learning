...
(cl:defclass <PolynomialTrajectory4D> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (segments
    :reader segments
    :initarg :segments
    :type (cl:vector planning_msgs-msg:PolynomialSegment4D)
   :initform (cl:make-array 0 :element-type 'planning_msgs-msg:PolynomialSegment4D :initial-element (cl:make-instance 'planning_msgs-msg:PolynomialSegment4D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PolynomialTrajectory4D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolynomialTrajectory4D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-msg:<PolynomialTrajectory4D> is deprecated: use planning_msgs-msg:PolynomialTrajectory4D instead.")))
...
(cl:defmethod segments-val ((m <PolynomialTrajectory4D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:segments-val is deprecated.  Use planning_msgs-msg:segments instead.")
  (segments m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PolynomialTrajectory4D>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'segments)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'planning_msgs-msg:PolynomialSegment4D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PolynomialTrajectory4D>)))
  ...
  "planning_msgs/PolynomialTrajectory4D")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PolynomialTrajectory4D)))
  "Returns string type for a message object of type 'PolynomialTrajectory4D"
  "planning_msgs/PolynomialTrajectory4D")
