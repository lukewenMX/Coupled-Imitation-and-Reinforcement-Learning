...
(cl:defmethod cl:initialize-instance :after ((m <Point2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-msg:<Point2D> is deprecated: use planning_msgs-msg:Point2D instead.")))
