...
(cl:defclass <PolygonWithHoles> (roslisp-msg-protocol:ros-message)
  ((hull
    :reader hull
    :initarg :hull
    :type planning_msgs-msg:Polygon2D
    :initform (cl:make-instance 'planning_msgs-msg:Polygon2D))
   (holes
    :reader holes
    :initarg :holes
    :type (cl:vector planning_msgs-msg:Polygon2D)
   :initform (cl:make-array 0 :element-type 'planning_msgs-msg:Polygon2D :initial-element (cl:make-instance 'planning_msgs-msg:Polygon2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PolygonWithHoles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonWithHoles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning_msgs-msg:<PolygonWithHoles> is deprecated: use planning_msgs-msg:PolygonWithHoles instead.")))

(cl:ensure-generic-function 'hull-val :lambda-list '(m))
(cl:defmethod hull-val ((m <PolygonWithHoles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:hull-val is deprecated.  Use planning_msgs-msg:hull instead.")
  (hull m))

(cl:ensure-generic-function 'holes-val :lambda-list '(m))
(cl:defmethod holes-val ((m <PolygonWithHoles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning_msgs-msg:holes-val is deprecated.  Use planning_msgs-msg:holes instead.")
  (holes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PolygonWithHoles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'holes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'planning_msgs-msg:Polygon2D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PolygonWithHoles>)))
  ...
  "planning_msgs/PolygonWithHoles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PolygonWithHoles)))
  "Returns string type for a message object of type 'PolygonWithHoles"
  "planning_msgs/PolygonWithHoles")
