...
class TD3(object):
    ...
    def choose_action(self, state, noise=False): # There should be no noise for the offline training
    ...
    def Learn(self):
        ...
        self.critic1_q.append(torch.mean(y_predicted1).detach())
        self.critic2_q.append(torch.mean(y_predicted2).detach())
