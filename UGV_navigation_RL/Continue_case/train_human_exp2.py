...
def test(args):
    ...
    np.savetxt(args.path_to_model+args.model_name+args.model_date+'/reward_list1.txt', reward_list)
...
if __name__ == '__main__':
    ...
    folder_name = '/with/luke_15'

    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', default='TD3')
    parser.add_argument('--init_folder',default='')
    ...
    parser.add_argument('--path_to_model', default='/home/lukewen/UGV_navigation_RL/weights/')
    parser.add_argument('--action_bound', default=[0.5,0.8], type=list)
