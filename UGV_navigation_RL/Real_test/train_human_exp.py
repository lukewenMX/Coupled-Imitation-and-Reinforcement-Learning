...
def get_time(start_time):
    ...
    h, m = divmod(m, 60)
    print colored('Total time spent: %d:%02d:%02d' % (h, m, s),"red")
...
if __name__ == '__main__':
    ...
    # folder_name = '/with/luke_18'
    # folder_name = '/without/luke_20'
    # folder_name = '/CIRL/DATA/CIRL_1'
    # folder_name = '/HE/DATA/CIRL_1'
    # folder_name = '/without/CIRL_3(test_model)'
    ...
    parser.add_argument('--action_bound', default=[0.5,0.3], type=list) # 0.3 0.5
