...
class Husky(object):
    ...
    def __init__(self, goal=GOAL_1):
        ...
        #  rospy.Subscriber('/odometry/filtered', Odometry, self.get_odom,queue_size=5)
        self.goal_count = 1
    ...
    def get_odom(self, data):
        ...
        # self.pos[2] = robot_orientation[2] * float(180.0 / 3.141592654)
    ...
    def step(self, action):
        ...
        reward, done,success = self.get_reward(dis,done,action)
    ...
    def reset(self):
        ...
        #print(self.pos)
        self.prev_dist = (np.linalg.norm([self.pos[0] - self.target_pos[0], self.pos[1] - self.target_pos[1]]))
    ...
    def discretize_observation(self, data, new_ranges):
        ...
        for i, item in enumerate(data.ranges):
            ...
            if (min_range > data.ranges[i] > 0):
                ...
                print colored('hit obstacle','yellow')
        discretized_ranges = np.array(discretized_ranges)
        lidar = discretized_ranges
        return lidar, done
    ...
    def get_state(self,action):
        ...
        x = self.pos[0] - self.target_pos[0]
        y = self.pos[1] - self.target_pos[1]
    ...
    def get_reward(self,dis,done,action):
        ...
        #reward = -0.1 * dis
        reward = -0.1 * (dis - self.prev_dist) - 0.004
        self.prev_dist = dis
        t = False
        ...
        if dis < 0.8:
            ...
            if self.get_counter > threshod:
                ...
                t = True
                self.get_counter = 0
                print colored('reach target completedly',"green")
        else:
            self.get_counter = 0
    ...
    def target_vis(self, goal):
        ...
        try:
            ...
            print("gazebo/delete_model failed.")
        # delete_model(target_name)
        ...
        try:
            s(target_name, self.target_xml, "", pose, "world")
        except (rospy.ServiceException) as e:
            print("gazebo/spaen_sdf_model failed.")
    ...
    def check_joy_action(self):
        ...
        if(joyAction.linear.x == 0.0) and (joyAction.angular.z == 0.0):
            ...
            received_action[0] = np.clip(received_action[0], 0.0,1.0)
