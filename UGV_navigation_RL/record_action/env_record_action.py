...
class Husky(object):
    ...
    def get_odom(self, data):
        ...
        # self.pos[0] = data.pose[13].position.x
        # self.pos[1] = data.pose[13].position.y
    ...
    def get_state(self,action):
        ...
        # x = pose.pose[13].position.x - self.target_pos[0]
        # y = pose.pose[13].position.y - self.target_pos[1]
        ...
        # quaternion = (pose.pose[13].orientation.x,
        #               pose.pose[13].orientation.y,
        #               pose.pose[13].orientation.z,
        #               pose.pose[13].orientation.w)
    ...
    def target_vis(self, goal):
        ...
        try:
            ...
            print("gazebo/spawn_sdf_model failed.")
