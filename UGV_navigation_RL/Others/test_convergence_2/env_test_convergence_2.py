...
class Husky(object):
    ...
    def get_state(self,action):
        ...
        #state = np.concatenate((lidar,related_pos,dis,action,get_goal),axis=None)
        state = np.concatenate((lidar,related_pos,dis,get_goal),axis=None)
